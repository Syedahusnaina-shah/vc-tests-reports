...
- Name: as1360-master.spec.js >> 🟣 INTERACTIVE ELEMENTS — Buttons, inputs, tabs fully visible >> ✅ TC-I03 | [1920x1080] Main content area is not crushed (has usable width)
- Location: as1360-master.spec.js:818:5

# Error details

```
Error: [1920x1080] Main content area should be at least 300px wide
