...
- Name: as1360-complete.spec.js >> 🟡 SINGLE MESSAGE TESTING — Send message & check responsiveness >> ✅ TC-S01 | Single Message Testing tab loads correctly
- Location: as1360-complete.spec.js:549:3

# Error details

```
Error: Message input should be visible on Single Message tab
          ...
          - generic [ref=e134]:
            ...
            - generic [ref=e136] [cursor=pointer]:
              ...
              - img [ref=e143]:
                - img [ref=e144]
        - generic [ref=e147]:
          - heading "Channels Notification delivery channels" [level=2] [ref=e148]:
            - text: Channels
            - generic [ref=e150]: Notification delivery channels
          - generic [ref=e151]:
            - generic:
              - generic:
              ...
              - generic:
                - generic:
                  - generic: Slack
        - button "Add Notification" [ref=e153] [cursor=pointer]:
          - generic [ref=e154]: Add Notification
  - generic [ref=e156]:
    - button "Save as Draft" [ref=e157] [cursor=pointer]:
      - generic [ref=e158]: Save as Draft
    - button "Next" [disabled] [ref=e159]:
      - generic: Next
```
